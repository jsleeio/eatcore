...
int main(int argc, char **argv)
{
	...
	logger("Starting with interval=%d, baseline=%d, increment=%d, max_increments=%d, random=%d",
	       (int)ctx.interval, (int)ctx.baseline, (int)ctx.increment, (int)ctx.max_increments, ctx.random);
